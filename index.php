...
if (isset($_POST['next'], $_POST['zipcode'])) {
  ...
  if (validateZipCode($zipcode, $data)) {
    ...
    header("Location: step-2.php?age=" . $_GET['age'] . "&household_size=" . $_GET['household_income'] . "&household_income=" . $_GET['household_income'] ."&utm_source=" .  $_GET['utm_source'] ."&utm_medium=" . $_GET['utm_medium'] ."&utm_campaign=" .  $_GET['utm_campaign'] ."");
