...
<!-- Navbar -->
  ...
  <section class="section__stepsbar padding-section">
    ...
    <div class="section__stepsbar-box">
      ...
      <div class="section__stepsbar-icon">
        <center><span class="current-step"><img src="assets/img/step-icons/cake-candles-solid.svg" alt="age"></img></span></center>
        <center><p>Age</p></center>
      </div> <!-- ./section__steps-icon -->

      <!-- section__steps-icon -->
      <div class="section__stepsbar-icon">
        <center><span><img src="assets/img/step-icons/card.svg" alt="medicare-card"></img></span></center>
  ...
  <section class="section__progressbar padding-section">
    <div class="section__progressbar-box">
      <div class="section__progressbar-fill" style="width:66%"></div>
      <div class="section__progressbar-filled" style="width:33%"></div> 
    </div>
    <p>
      <b>Progress</b>
    </p>
