...
if(isset($_POST['next'], $_POST['medicarecard'])) {
  $_SESSION['info']['medicarecard']=  $_POST['medicarecard'];
  $_SESSION['info']['next']= $_POST['next'];

  // Redirecto to step-3.php
  header("Location: thanks.php?age=" . $_SESSION['info']['age']  . "household_size=" .  $_SESSION['info']['householdsize']. "&household_income=" .  $_SESSION['info']['householdestimated'] ."");
}
?>
...
<!-- Navbar -->
  ...
  <section class="section__progressbar padding-section">
    ...
    <div class="section__progressbar-box">
      ...
      <div class="section__progressbar-filled" style="width:66%"></div> 
    </div>
    <p>
      <b>Progress</b>
    </p>
  ...
  <section class="section__currentstep padding-section">
    ...
    <center>
      <form method="POST" class="section__step-form">
        <label>Do You Have Medicare Parts A & B?</label> <br/><br/>
        ...
        <input type="radio" id="html" name="medicarecard" value="yes" required>
        <label for="html">Yes</label>

        <span class="divider-step-choice">  | </span>

        <input type="radio" id="css" name="medicarecard" value="no">
