...
$parameter = "?firstName=" . $_GET['firstName'] . "&lastName=" . $_GET['lastName'] . "&phone=" . $_GET['phone'] . "&email=" . $_GET['email'] . "&address=" . $_GET['address'] . "&zipCode=" . $_GET['zipCode'] . "&age=" .$_GET['age']. "&gender=" . $_GET['gender']."&Pub_Id=".$_GET['Pub_Id']."&Sub_Id=".$_GET['Sub_Id']."&householdsize=". $_GET['householdsize']."&householdestimated=".$_POST['householdestimated'];
  ...
  <section class="section__currentstep padding-section">
    ...
    <center>
      <form method="POST" class="section__step-form">
        <label>What is your estimated annual Household income for 2023 (before taxes)?</label> <br/><br/>
