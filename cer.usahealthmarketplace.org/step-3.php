...
if(isset($_POST['next'], $_POST['householdsize'])) {
 ...
 header("Location: step-4.php?firstName=" . $_GET['firstName'] . "&lastName=" . $_GET['lastName'] . "&phone=" . $_GET['phone'] . "&email=" . $_GET['email'] . "&address=" . $_GET['address'] . "&zipCode=" . $_GET['zipCode'] . "&age=" . $_GET['age']. "&gender=" . $_GET['gender']."&Pub_Id=".$_GET['Pub_Id']."&Sub_Id=".$_GET['Sub_Id']."&householdsize=". $_POST['householdsize']);
exit;
}
?>
