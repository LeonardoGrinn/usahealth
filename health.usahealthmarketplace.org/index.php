  ...
  <section class="section__hero">
    ...
    <div class="section__hero-textbox">
      ...
      <div class="section__hero-textbox-content">
          ...
          <h4>
            <u>2024 Health Subsidy Benefits:</u> <br/><br/>
            ✔ <strong>$6,300</strong> Subsidies<br>
            ✔ Up to <strong>$500</strong> Rewards Card<br>
            ✔ Health Insurance for $0 Month
          </h4>
        ...
        <center>
          <form method="POST" class="section__hero-form">
            ...
            <a class="btn btnForm getstarted" name="next" id ="getStartedButton" href="" style="">See If I Qualify</a>
          </form>
          <div>
