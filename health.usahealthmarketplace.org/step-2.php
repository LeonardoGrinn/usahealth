...
header("Location: step-3.php?firstName=" . $_GET['firstName'] . "&lastName=" . $_GET['lastName'] . "&phone=" . $_GET['phone'] . "&email=" . $_GET['email'] . "&address=" . $_GET['address'] . "&zipCode=" . $_GET['zipCode'] . "&age=" .$age. "&gender=" . $_GET['gender']."&Pub_Id=".$_GET['Pub_Id']."&Sub_Id=".$_GET['Sub_Id'] );
exit;
  } 
  ...
  if ($age >= 65) {
    ...
    header("Location: https://seniors.usahealthmarketplace.org/step-3.php");
  }
}
...
<!-- Navbar -->
  ...
  <section class="section__stepsbar padding-section" style="display:none">
    ...
    <div class="section__stepsbar-box">
      ...
      <!-- section__steps-icon -->
      <div class="section__stepsbar-icon">
        <center><span><img src="assets/img/step-icons/id-card-solid.svg" alt="results"></img></span></center>
  ...
  <section class="section__currentstep padding-section" style="margin-top: 10%;">
    
    <!-- First Form -->
    <center>
      <form method="POST" class="section__step-form">
        <!--<label>How old are you?</label>--> 
        <label>Do you have <strong>Medicare</strong> or <strong>Medicaid</strong>?</label><br/><br/>
        <!--<input required type="text" value="<?= isset( $_GET['age']) ? $_GET['age']: '' ?>"  placeholder="Age" name="age">-->  <br/>
        <div style="display:inline-block;height: 50px;padding-top: 20px;">
            <a class="btn btnForm btnWidth" href="https://health.usahealthmarketplace.org/health-listings.php">Yes</a>
            <a class="btn btnForm btnWidth" href="https://health.usahealthmarketplace.org/thanks.php">No</a>
