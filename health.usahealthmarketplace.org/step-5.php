...
function validateDuplicateError(errorMessage) {
 const errorPattern = /Insert Error #3: Duplicate lead value - the lead with the Primary_Phone: (.+) has been submitted within the past 30 days./i;
    ...
    fetch(url, requestOptions)
      ...
      .then(data => {
        ...
        if (status === 'Error') {
          ...
          btNext.value = 'Send';
            const isDuplicateError = validateDuplicateError(error);
