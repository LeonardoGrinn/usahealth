...
if(isset($_POST['next'], $_POST['age'])) {
  ...
  $_SESSION['info']['utm_source']= 'emodo';
  $_SESSION['info']['utm_medium']= 'dsp';
  $_SESSION['info']['utm_campaign']= 'usahealth';
  ...
  if ($age >= 25 && $age <= 64) {
    ...
    header("Location: step-3.php?age=" . $_SESSION['info']['age']  . "household_size=" .  $_SESSION['info']['householdsize']. "&household_income=" .  $_SESSION['info']['householdestimated'] ."&utm_source=" .  $_SESSION['info']['utm_source'] ."&utm_medium=" .  $_SESSION['info']['utm_medium'] ."&utm_campaign=" .  $_SESSION['info']['utm_campaign'] ."");
  } 
  ...
  <section class="section__currentstep padding-section">
    ...
    <center>
      <form method="POST" class="section__step-form">
        ...
        <input type="hidden" id="utm_source" name="utm_source" value="emodo" />
        <input type="hidden" id="utm_medium" name="utm_medium" value="dsp" />
        <input type="hidden" id="utm_campaign" name="utm_campaign" value="usahealth" />
         <!-- Form buttons -->
        <div class="mt-2 pt-2">
